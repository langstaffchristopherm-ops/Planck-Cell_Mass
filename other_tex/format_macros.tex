...
\usepackage{siunitx}
\usepackage{xurl}            % robust URL line-breaking
\usepackage{ragged2e}
...
% --- Make DOIs clickable when the .bst prints them ---
\usepackage{doi}
% Ensure the doi macro hyperlinks to doi.org even if the .bst prints plain text
\makeatletter
...
% Use this macro in main.tex: \bibliographystyle{\DefaultBibStyle}
...
% --- Identity ---
\providecommand{\PaperTitleMain}{Planck-Cell --- Mass}
